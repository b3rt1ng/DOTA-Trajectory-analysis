...
Affinity propagation is a bit more complex to implement in python since one of the most interesting optimization is the use of parallelism. Tho numpy has been a life saver when it comes to matrix operations in the iterative process of the algorithm.
